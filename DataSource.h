...
namespace bridges {
	...
	class DataSource {
		...
		public:
      static vector<ActorMovieIMDB> a;
			 ...
			 */
//made it so we can use this to add to a vector
        ...
        // Parser for imdb data 1
        url = "http://bridgesdata.herokuapp.com/api/imdb?limit=1813";

				// retrieve the data and parse
				d.Parse(ServerComm::makeRequest( url, {"Accept: application/json"}).c_str());

				const Value& D2 = d["data"];
